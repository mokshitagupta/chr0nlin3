        ...
        if ($database === null) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($requestData !== null && isset($requestData['search'])) {
                    ...
                    $sql = "SELECT * FROM media WHERE media_type = 'Movie' AND LOWER(media_name) LIKE LOWER(:search)";
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        echo json_encode(["message" => "No movie found matching the search criteria."]);
                    }
                } else {
