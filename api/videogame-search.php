        ...
        if ($database === null) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($requestData !== null && isset($requestData['search'])) {
                    ...
                    $sql = "SELECT * FROM media WHERE media_type = 'Videogame' AND LOWER(media_name) LIKE LOWER(:search)";
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        echo json_encode(["message" => "No video games found matching the search criteria."]);
                    }
                } else {
