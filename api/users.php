        ...
        if ($database === null) {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($requestData !== null && isset($requestData['search'])) {
                    ...
                    // Prepare a SQL query to retrieve media data from the "media" table where media_type is "Movie"
                    $sql = "SELECT media_name, creator, media_type, score FROM media WHERE media_type = 'Videogame' AND (LOWER(media_name) LIKE LOWER(:search))";
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        echo json_encode(["message" => "No users found you bum you block you stone you worse than senseless thing."]);
                    }
                } else {
